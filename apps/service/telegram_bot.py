...
class TelegramBotService:
    ...
    def send_message(cls, chat_id: int | str, text: str, parse_mode: str | None = "HTML") -> bool:
        ...
        parse_mode=None bo'lsa, matn formatlanmagan holda yuboriladi — bu
        foydalanuvchi kiritgan, ishonib bo'lmaydigan matn (masalan,
        ContactMessage.message) uchun xavfsizroq, chunki HTML teglari
        Telegram tomonidan xato deb qaytarilishi mumkin.
        """
        ...
        try:
            ...
            logger.error("Telegram sendMessage tarmoq xatoligi: chat_id=%s err=%s", chat_id, e)
            return False
