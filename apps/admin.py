...
class CenterStaffAdmin(ModelAdmin):
    ...
    list_filter = ['center']
    search_fields = ['user__first_name', 'user__last_name', 'user__phone', 'center__name']
...
class GroupAdmin(ModelAdmin):
    list_display = ['id', 'name', 'course', 'teacher', 'room', 'status', 'student_count']
...
class PaymentAdmin(ModelAdmin):
    list_display = ['id', 'student', 'group', 'amount', 'discount', 'final_amount', 'method', 'status', 'paid_at']
    list_filter = ['status', 'method', 'status', 'created_at']
    search_fields = ['student__user__first_name', 'student__user__last_name', 'group__name', 'period_month']
...
class NotificationRecipientAdmin(ModelAdmin):
    ...
    search_fields = ['recipient__first_name', 'recipient__last_name', 'recipient__phone', 'notification__title']
