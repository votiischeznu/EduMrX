...
class BaseStudentStatsSerializer(serializers.Serializer):
    new_this_month = serializers.IntegerField(help_text="Shu oyda qo'shilgan yangi o'quvchilar")
...
class BaseRevenueStatsSerializer(serializers.Serializer):
    ...
    percentage_change = serializers.FloatField(help_text="O'tgan oyga nisbatan foizdagi farq")
...
class BaseSubscriptionStatsSerializer(serializers.Serializer):
    ...
    enterprise = serializers.IntegerField(help_text="Enterprise tarifidagi markazlar soni")
...
class StudentGrowthSerializer(serializers.Serializer):
    ...
    count = serializers.IntegerField(help_text="O'sha oydagi jami kumulyativ o'quvchilar soni")
...
class TopCentersSerializer(serializers.Serializer):
    ...
    percentage = serializers.IntegerField(help_text="Eng katta markazga nisbatan foiz ko'rsatkichi")
