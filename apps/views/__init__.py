...
from apps.views.auth_views import RegisterVerifyAPIView
...
from apps.views.management_views import ManagementAttendanceViewSet, ManagementStudentDetailView, ManagementTeacherDetailView
